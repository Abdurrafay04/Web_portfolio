...
! function(e, t) {
    ...
    return function(e) {
        var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
            ...
            f = t(t({}, o), r);
        if (!a(e)) throw new TypeError("Expected element to be a valid HTML element.");
        for (var u = f.text && "string" == typeof f.text ? f.text.split("") : e.textContent.split(""), l = [], c = [], s = 0; s < u.length; s += 1) {
            var p = u[s];
            /\s/.test(p) ? l[s] = "space" : (/[a-z]/.test(p) ? l[s] = "lowerCase" : /[A-Z]/.test(p) ? l[s] = "upperCase" : l[s] = "symbol", c.push(s))
        }
        e.textContent = "";
        var y = null;
        return function t(r) {
                var o = n(u),
                    a = c.length;
                if (r > a) "function" == typeof f.onComplete && f.onComplete(e);
                else {
                    for (var s = Math.max(r, 0); s < a; s += 1) s < r + f.iterations ? o[c[s]] = i(l[c[s]]) : o[c[s]] = "";
                    e.textContent = o.join(""), y = setTimeout((function() {
                        t(r + 1)
                    }), 1e3 / f.fps)
                }
            }(-f.iterations),
